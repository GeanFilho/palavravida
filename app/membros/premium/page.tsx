...
import { Download, Calendar, BookOpen, Menu, X, ArrowRight, Users } from "lucide-react"
...
export default function MembrosPremiumPage() {
  ...
  useEffect(() => {
    ...
    setUser(parsedUser)
    setDailyDevotionals(getDevotionalsForPlan("premium", 4))
  }, [router])
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          {mobileMenuOpen && (
            <div className="lg:hidden mt-4 pb-4 space-y-3 border-t border-border pt-4">
              ...
              <div className="pt-3 border-t border-border">
                ...
                <p className="text-xs text-muted-foreground mb-3">Plano Premium</p>
              </div>
            </div>
          )}
        </nav>
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-16 sm:mb-20 max-w-3xl">
        ...
        <section className="mt-20">
          <Card className="border-2 border-primary/30 bg-gradient-to-br from-primary/5 to-secondary/5">
            <CardContent className="p-8 sm:p-12 text-center">
              <h3 className="font-serif text-3xl sm:text-4xl font-bold mb-4">Quer Mais Conteúdo?</h3>
              <p className="text-lg text-muted-foreground mb-6 max-w-2xl mx-auto">
                Faça upgrade para o Plano Completo e tenha acesso a conteúdo para educação cristã de filhos e
                devocionais em família.
              </p>
