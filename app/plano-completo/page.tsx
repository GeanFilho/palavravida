...
export default function PlanoCompletoPage() {
  ...
  const handleSelectPlan = () => {
    if (user) {
      const updatedUser = { ...user, plan: "completo" }
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="font-serif text-4xl sm:text-5xl font-bold text-foreground mb-4">Plano Completo</h1>
            <p className="text-xl text-muted-foreground">Acesso total a toda biblioteca de conteúdo</p>
          </div>
              ...
              <div className="border-t border-border pt-8 mb-8">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Tudo do plano Premium incluído</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-secondary flex-shrink-0 mt-0.5" />
                    <span>14 ebooks + conteúdo extra exclusivo</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-secondary flex-shrink-0 mt-0.5" />
                    <span>5 devocionais variados por dia</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-secondary flex-shrink-0 mt-0.5" />
                    <span>Conteúdo para todas as idades</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-secondary flex-shrink-0 mt-0.5" />
                    <span>Histórias bíblicas ilustradas</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-secondary flex-shrink-0 mt-0.5" />
                    <span>Material pedagógico completo</span>
                  </li>
                </ul>
              </div>
